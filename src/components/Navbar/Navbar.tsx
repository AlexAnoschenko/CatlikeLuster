        ...
        <div className="flex gap-x-10">
          <Row gutter={30} className="text-lg select-none nunito">
            ...
            <Col>
              <Link
                className={`cursor-pointer ${
                  selectedPage === "/parents" && "border-b-2 border-black"
                }`}
                to="/parents"
            ...
            <Col>
              <Link
                className={`cursor-pointer ${
                  selectedPage === "/kittens" && "border-b-2 border-black"
                }`}
                to="/kittens"
            ...
            <Col>
              <Link
                className={`cursor-pointer ${
                  selectedPage === "/gallery" && "border-b-2 border-black"
                }`}
                to="/gallery"
            ...
            <Col>
              <Link
                className={`cursor-pointer ${
                  selectedPage === "/info" && "border-b-2 border-black"
                }`}
                to="/info"
            ...
            <Col>
              <Link
                className={`cursor-pointer ${
                  selectedPage === "/contacts" && "border-b-2 border-black"
                }`}
                to="/contacts"
          ...
          <Row gutter={10}>
            <Col>
              <img
                ...
                className={`cursor-pointer w-7 ${
                  language === "en" && "border-2 border-indigo-600 rounded-full"
                }`}
            ...
            <Col>
              <img
                ...
                alt="ru"
                className={`cursor-pointer w-7 ${
                  language === "ru" && "border-2 border-indigo-600 rounded-full"
                }`}
